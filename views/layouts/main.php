...
<div class="wrap">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ['label' => '文章管理', 'url' => ['/post/index']],      //修改导航栏
            ['label' => '评论管理', 'url' => ['/site/about']],
            ['label' => '用户管理', 'url' => ['/site/contact']],
            ['label' => '管理员', 'url' => ['/site/welcome']],
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; My Company Welcome <?= date('Y') ?></p>
